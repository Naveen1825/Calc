...
<head>
    ...
    <style>
        ...
        .button input[type="button"] {
            background-color:rgb(30, 142, 227);
            height: 50px;
            width: 50px;
            margin: 0 2px;
            border: 3px solid rgb(60, 76, 215);
        }
    </style>
</head>

<body style="background-color: rgb(0, 0, 0);">
        <h1 align="center" style="color: rgb(60, 76, 215);">SIMPLE CALCULATOR</h1>
	<h1 align="center" style="color: rgb(60, 76, 215);">Naveenkanthan 212223230138</h1>
        <div class="button">
            <center>
...
![image](https://github.com/Naveen1825/Calc/assets/138969868/fe604904-d189-43ff-8ddb-94d811e4462f)
